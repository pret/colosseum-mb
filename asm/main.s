...
AgbMain: @ 0x0200858C
	...
	mov r0, sp
	strh r4, [r0]
	ldr r1, =gUnknown_02020A34
	ldr r2, =gUnknown_0202526C
	subs r2, r2, r1
	lsrs r0, r2, #0x1f
	adds r2, r2, r0
	lsls r2, r2, #0xa
	...
	thumb_func_start sub_020085F4
sub_020085F4: @ 0x020085F4
	ldr r0, =gUnknown_02022C08
	ldr r0, [r0]
	bx lr
	.align 2, 0
	.pool

	thumb_func_start sub_02008600
sub_02008600: @ 0x02008600
	push {r4, lr}
	adds r4, r0, #0
	cmp r4, #0
	beq _0200862C
...
_0200862C:
	...
	thumb_func_start sub_02008638
sub_02008638: @ 0x02008638
	push {r4, r5, lr}
	ldr r1, =gUnknown_02022C0C
	movs r0, #0
	str r0, [r1]
	ldr r1, =gUnknown_02022BD0
	ldr r5, =sub_02008708
	ldr r4, =sub_020086B8
	adds r2, r5, #0
	adds r3, r1, #0
...
_0200866E:
	...
	thumb_func_start sub_02008674
sub_02008674: @ 0x02008674
	adds r3, r0, #0
	adds r2, r1, #0
	cmp r2, #0
	beq _0200868C
...
_0200884A:
	...
	thumb_func_start sub_02008850
sub_02008850: @ 0x02008850
	push {r4, r5, r6, lr}
	adds r6, r3, #0
	ldr r3, [sp, #0x10]
	ldr r4, [sp, #0x14]
