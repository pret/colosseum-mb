...
#define SPRITE_SIZE_8x8     ((ST_OAM_SIZE_0) | (ST_OAM_SQUARE << 2))
#define SPRITE_SIZE_16x16   ((ST_OAM_SIZE_1) | (ST_OAM_SQUARE << 2))
#define SPRITE_SIZE_32x32   ((ST_OAM_SIZE_2) | (ST_OAM_SQUARE << 2))
#define SPRITE_SIZE_64x64   ((ST_OAM_SIZE_3) | (ST_OAM_SQUARE << 2))

#define SPRITE_SIZE_16x8    ((ST_OAM_SIZE_0) | (ST_OAM_H_RECTANGLE << 2))
#define SPRITE_SIZE_32x8    ((ST_OAM_SIZE_1) | (ST_OAM_H_RECTANGLE << 2))
#define SPRITE_SIZE_32x16   ((ST_OAM_SIZE_2) | (ST_OAM_H_RECTANGLE << 2))
#define SPRITE_SIZE_64x32   ((ST_OAM_SIZE_3) | (ST_OAM_H_RECTANGLE << 2))

#define SPRITE_SIZE_8x16    ((ST_OAM_SIZE_0) | (ST_OAM_V_RECTANGLE << 2))
#define SPRITE_SIZE_8x32    ((ST_OAM_SIZE_1) | (ST_OAM_V_RECTANGLE << 2))
#define SPRITE_SIZE_16x32   ((ST_OAM_SIZE_2) | (ST_OAM_V_RECTANGLE << 2))
#define SPRITE_SIZE_32x64   ((ST_OAM_SIZE_3) | (ST_OAM_V_RECTANGLE << 2))
